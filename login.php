...
<body>
    <nav class="navbar">
        <a href="index.php" class="navbar-brand">
            <i class="fa-solid fa-graduation-cap"></i> Smart Event Campus
        </a>
        <div class="nav-links">
            <a href="index.php" class="btn btn-outline"><i class="fa-solid fa-arrow-left"></i> Beranda</a>
        </div>
    </nav>

    <div class="auth-container glass" style="margin-top: 8rem;">
