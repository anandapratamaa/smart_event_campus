...
<body>
    <nav class="navbar">
        <a href="admin.php" class="navbar-brand">
            <svg width="40" height="40" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" style="border-radius:8px;flex-shrink:0;">
                <rect width="100" height="100" rx="20" fill="url(#adminCsGrad)"/>
                ...
                <defs>
                    <linearGradient id="adminCsGrad" x1="0" y1="0" x2="100" y2="100" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#10b981"/>
                        <stop offset="1" stop-color="#f59e0b"/>
                    </linearGradient>
                </defs>
            </svg>
            <span style="-webkit-text-fill-color:transparent;background:linear-gradient(135deg,#10b981,#f59e0b);-webkit-background-clip:text;font-weight:700;">Admin Panel</span>
        </a>
        <button class="menu-toggle" onclick="document.getElementById('navLinks').classList.toggle('active')">
            <i class="fa-solid fa-bars"></i>
        </button>
        <div class="nav-links" id="navLinks">
            <a href="admin.php" class="btn btn-outline" style="font-size:0.9rem;padding:0.5rem 1rem;"><i class="fa-solid fa-arrow-left"></i> Dashboard</a>
            <a href="logout.php" class="btn btn-outline" style="border-color:#ef4444; color:#ef4444;"><i class="fa-solid fa-right-from-bracket"></i> Logout</a>
        </div>
    </nav>
